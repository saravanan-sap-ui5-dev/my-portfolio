		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Portfolio",
									"targetURL": "#commyportfolio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commyportfolio-display": {
								"semanticObject": "commyportfolio",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.myportfolio",
									"url": sap.ui.require.toUrl("com/myportfolio")
								}
							}
						}
					}
